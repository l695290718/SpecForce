...
export const threeAWebQuerySchema = z.discriminatedUnion("operation", [
  ...
  z.object({ operation: z.literal("unitGraph"), ...identity, generationId: z.string().min(1).max(256), includeMembers: z.boolean().optional(), filter: architectureMapFilter.optional(), budget: unitGraphBudget.optional(), continuation: z.string().max(4096).optional() }),
