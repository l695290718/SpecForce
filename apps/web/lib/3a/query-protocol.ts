...
export const threeAWebQuerySchema = z.discriminatedUnion("operation", [
  ...
  z.object({ operation: z.literal("unitGraph"), ...identity, generationId: z.string().min(1).max(256), filter: architectureMapFilter.optional(), budget: architectureMapBudget.optional(), continuation: z.string().max(4096).optional() }),
