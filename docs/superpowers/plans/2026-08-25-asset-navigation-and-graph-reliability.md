...
- [ ] **Step 2: Run the focused core test and verify the regression fails**
...
- [ ] **Step 3: Implement a typed read-boundary normalizer**
...
- [ ] **Step 5: Commit the graph compatibility change**
...
- [ ] **Step 2: Run the route helper test and verify the current behavior**
...
- [ ] **Step 3: Implement URL-based Scope replacement**
...
- [ ] **Step 4: Run the route helper and affected UI tests**
...
- [ ] **Step 5: Commit the scoped navigation change**
...
- [ ] **Step 2: Rebuild and restart the supported Docker topology**
...
- [ ] **Step 3: Verify affected pages and graph API**
...
- [ ] **Step 4: Update design evidence and close the same session**
