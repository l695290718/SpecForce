...
> **Execution status:** Implemented and verified on 2026-09-20. Steps are retained as the traceable execution record.
...
- [x] **Step 1: Write the failing probe assertions.**
...
- [x] **Step 2: Create the temporary missing-link snapshot.**
...
- [x] **Step 3: Insert missing endpoints and relationships.**
...
- [x] **Step 4: Insert exactly one event and Outbox record per repair.**
...
- [x] **Step 5: Run SQL lint and probe tests.**
...
- [x] **Step 6: Commit the repair migration.**
...
- [x] **Step 1: Add audit command tests.**
...
- [x] **Step 2: Implement read-only audit mode.**
...
- [x] **Step 3: Implement guarded apply mode.**
...
- [x] **Step 4: Add failure-safe audit records.**
...
- [x] **Step 5: Run command tests and typecheck.**
...
- [x] **Step 6: Commit the baseline command.**
...
- [x] **Step 1: Restore the backup and calculate the reviewed digest.**
...
- [x] **Step 2: Resolve only the historical allowlist in the probe.**
...
- [x] **Step 3: Deploy current migrations in the probe.**
...
- [x] **Step 4: Run postconditions twice.**
...
- [x] **Step 5: Drop only the named probe database.**
...
- [x] **Step 6: Commit probe evidence.**
...
**Files:**
- Modify: `docs/TODO.md`
- Create: `docs/adr/0050-canonical-postgresql-brownfield-baseline.md`
- Modify: `docs/design-facts/baseline-manifest.json`
- Modify: `docs/evidence/governed-full-asset-repository-scan.md`

- [x] **Step 1: Take a fresh canonical backup.**
...
- [x] **Step 2: Run guarded apply with explicit canonical confirmation.**
...
- [x] **Step 3: Verify canonical migration state and data invariants.**
...
- [x] **Step 4: Synchronize and close MCP design facts.**
