...
- [ ] **Step 1: Open the implementation preflight in the exact owning Scope**
...
- [ ] **Step 2: Add bounded summary and impact types before implementation**
...
- [ ] **Step 3: Add the query union and safe API routing tests**
...
- [ ] **Step 4: Implement pure impact scoring and band classification**
...
- [ ] **Step 5: Run the contract and pure-model tests**
...
- [ ] **Step 6: Commit the stable graph-analysis contracts**
...
- [ ] **Step 1: Write repository contract tests for Scope and generation binding**
...
- [ ] **Step 2: Add derived summary models and indexes**
...
- [ ] **Step 3: Implement repository summary reads**
...
- [ ] **Step 4: Test bounded ordering, pagination, and stale analysis behavior**
...
- [ ] **Step 5: Run repository tests and schema validation**
...
- [ ] **Step 6: Commit derived storage and repository boundaries**
...
- [ ] **Step 1: Define analysis materializer input and publication output**
...
- [ ] **Step 2: Write materializer tests before wiring the projector**
...
- [ ] **Step 4: Wire analysis publication after Projection Manifest publication**
...
- [ ] **Step 5: Verify projector restart and idempotency**
...
- [ ] **Step 6: Commit projection publication**
...
- [ ] **Step 1: Add service contract tests for overview and impact**
...
- [ ] **Step 2: Implement operation-specific continuation fingerprints**
...
- [ ] **Step 3: Implement Overview and Impact service methods**
...
- [ ] **Step 4: Route and sanitize the new Web operations**
...
- [ ] **Step 6: Commit query operations**
...
- [ ] **Step 1: Add pinned graph dependencies**
...
- [ ] **Step 2: Define the store boundary and retention policy**
...
- [ ] **Step 3: Write store tests before implementing Graphology mutation**
...
- [ ] **Step 4: Implement semantic zoom and neighborhood reducers**
...
- [ ] **Step 5: Define the layout Worker protocol**
...
- [ ] **Step 6: Run store and Worker tests**
...
- [ ] **Step 7: Commit the Graphology state layer**
...
- [ ] **Step 1: Write renderer lifecycle tests without a real WebGL context**
...
- [ ] **Step 2: Implement the Sigma adapter**
...
- [ ] **Step 3: Implement Overview, Explore, and Impact layout adapters**
...
- [ ] **Step 4: Implement WebGL fallback and context recovery**
...
- [ ] **Step 5: Test reduced motion, resize, and bounded canvas**
...
- [ ] **Step 7: Commit the WebGL renderer**
...
- [ ] **Step 1: Extend URL state with `graphView`**
...
- [ ] **Step 3: Implement the graph workspace coordinator**
...
- [ ] **Step 4: Implement the Overview search and cluster drill-down**
...
- [ ] **Step 5: Implement Impact panel and score explanation**
...
- [ ] **Step 6: Add bilingual copy and reduced-motion styles**
...
- [ ] **Step 7: Test desktop/mobile DOM behavior**
...
- [ ] **Step 8: Run the integrated Web test suite**
...
- [ ] **Step 9: Commit the integrated graph workspace**
...
- [ ] **Step 1: Add source regression checks for bounded behavior**
...
- [ ] **Step 2: Run backend, frontend, governance, and build verification**
...
- [ ] **Step 3: Run browser acceptance at desktop and mobile sizes**
...
- [ ] **Step 4: Update implemented ADR/Proposal/Context Pack evidence**
...
- [ ] **Step 5: Synchronize and read back exact-Scope design facts**
...
- [ ] **Step 6: Close the same implementation session**
...
- [ ] **Step 7: Update deployment and operator documentation**
...
- [ ] **Step 8: Commit the completed acceptance**
...
- No implementation claim: the current approved design records remain approved until Task 8 evidence is complete.
