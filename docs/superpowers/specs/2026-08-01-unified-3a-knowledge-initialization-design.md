...
**Status:** Phase 1 generic foundation implemented; initialization governance, scanning, 3A projections, and migration hardening remain pending. The Windows standalone artifact check is environment-blocked by pnpm symlink permissions.
